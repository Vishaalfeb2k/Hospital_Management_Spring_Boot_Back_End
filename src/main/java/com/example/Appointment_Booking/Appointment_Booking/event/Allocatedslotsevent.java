package com.example.Appointment_Booking.Appointment_Booking.event;
...
@Data
public class Allocatedslotsevent 
{
	public int id;
	...
	public Allocatedslotsevent(int id, String specializtion, String slot1, String slot2, String hospital_private,
